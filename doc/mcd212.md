...
The FCT can contain a maximum of 1024 instructions.
That would mean 2048 memory reads, because one instruction is 32 bit.


### According to the datasheet of the MCD212

It is stated that the vertical blanking period can hold 2640 memory fetches at max.
This would match the requirement of the Green Book with some safety margin.
